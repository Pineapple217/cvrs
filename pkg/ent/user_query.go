...
func (uq *UserQuery) FirstID(ctx context.Context) (id pid.ID, err error) {
	var ids []pid.ID
...
func (uq *UserQuery) FirstIDX(ctx context.Context) pid.ID {
...
func (uq *UserQuery) OnlyID(ctx context.Context) (id pid.ID, err error) {
	var ids []pid.ID
...
func (uq *UserQuery) OnlyIDX(ctx context.Context) pid.ID {
...
func (uq *UserQuery) IDs(ctx context.Context) (ids []pid.ID, err error) {
...
func (uq *UserQuery) IDsX(ctx context.Context) []pid.ID {
	ids, err := uq.IDs(ctx)
	if err != nil {
		panic(err)
	}
