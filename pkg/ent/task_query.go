...
func (tq *TaskQuery) FirstID(ctx context.Context) (id pid.ID, err error) {
	var ids []pid.ID
...
func (tq *TaskQuery) FirstIDX(ctx context.Context) pid.ID {
...
func (tq *TaskQuery) OnlyID(ctx context.Context) (id pid.ID, err error) {
	var ids []pid.ID
...
func (tq *TaskQuery) OnlyIDX(ctx context.Context) pid.ID {
...
func (tq *TaskQuery) IDs(ctx context.Context) (ids []pid.ID, err error) {
...
func (tq *TaskQuery) IDsX(ctx context.Context) []pid.ID {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
