...
func (tc *TaskCreate) SetPayload(jm json.RawMessage) *TaskCreate {
	tc.mutation.SetPayload(jm)
	return tc
}
...
func (tc *TaskCreate) SetID(pi pid.ID) *TaskCreate {
	tc.mutation.SetID(pi)
	return tc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (tc *TaskCreate) SetNillableID(pi *pid.ID) *TaskCreate {
	if pi != nil {
		tc.SetID(*pi)
	}
	return tc
